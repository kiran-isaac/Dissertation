...
Following this meeting, I broke down this brief into smaller parts. Taking an ethnographic approach, I used my own experience teaching functional languages to consider solutions and come up with requirements for each part. 
...
During the testathon [REFHERE: Testathon] in cycle 2, participants were given a survey to fill in. The participants were a mixture of undergraduate and postgraduate computer scientists, all of whom had taken the first year FP unit. In one section of the survey, they were presented with a series of statements designed to gauge their feelings towards functional languages. A Likert scale\cite{likert1932technique} was used to measure the attitudes of participants towards the statements. 

\begin{figure}[t]
    \centering
    \includegraphics[width=\linewidth]{images/testathon_fp.png}
    \caption{The results of a survey performed during the testathon, where I used a Likert scale to gauge participants feelings towards functional programming languages}
    \label{fig:fp_is_hard}
\end{figure}

$60\%$ of respondents strongly/agreed that they knew functional languages, but only $47.6\%$ of people would strongly/agree that they knew how these languages work.  
