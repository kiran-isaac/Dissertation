...
\subsubsection{Building Intuition} This is the key to an effective solution. Many students to the first year FP unit do not have any experience with functional programming, and find it difficult to gain an intuition from passively watching lectures, and do not attend or engage with labs. 
...
% \subsection{Cycle Conclusion}
% This iteration was successful in its goal of producing an effective proof of concept. Future cycles will focus on extending the language   