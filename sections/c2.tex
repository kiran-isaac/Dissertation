...
\begin{itemize}
    ...
    \synjudg{\Gamma}{e}{A}{\Theta}$).
    \item Then, after we subsitute all of the information in context $\Theta$ into types $A$ and $B$, we can derive that $A$ is a subtype of $B$ (\subjudg{\Theta}{[\Theta]A}{[\Theta]B}{\Delta})
\end{itemize}
