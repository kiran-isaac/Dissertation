...
\section{Evaluation}
\label{ref:afg_figma}
The aims of this cycle were to develop the language as well as some other more technical features of this project. 

At the end of this cycle, to evaluate and to discuss next steps, I held a focus group. As the UI/UX was not polished at this stage, I wanted to find people who would be able to discuss the parts that I had already implemented to a reasonable level of completion: the language. However, I still wanted to discuss future steps for the system as a whole, rather than just the language. Because of this, I wanted to find people who had only recently learned functional languages as a part of a university course, so they would have an insight into what is required for the system to be useful for use in this setting. I wanted to find people who knew as much as possible about functional languages, but they had 
