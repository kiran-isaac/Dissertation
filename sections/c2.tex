...
We have a function \sflinline{f x = inc x} (desugared: \sflinline{f = (\x. inc x)}) that we want to synthesize the type of. \sflinline{inc} is a previously defined function with a type of $Int \arr Int$. 

\begin{mathpar}
\Gamma_0 = \text{inc}: Int \arr Int\\
...
\Infer{%
        {\!\ArrIntroSyn[1]}
           ...
           { \chkjudg{\Gamma_0, \ahat, \bhat, x : \ahat}{\text{inc x}}{\bhat}{\Delta, x : \ahat, \Theta}
           }
           {{\synjudg{\Gamma_0}{\lam{x} \text{inc x}}{\ahat \arr \bhat}{\Delta}}}

        \Infer{\Sub[2]}
            {
                \synjudg{\Gamma_1}{\text{inc x}}{A}{\Theta}[3]
                \\
                \subjudg{\Theta}{[\Theta]A}{[\Theta]\bhat}{\Delta}
            }
            {\chkjudg{\Gamma_1}{\text{inc x}}{\bhat}{\Delta}}

        \Infer{\!\ArrElim[3]}
            {\Infer{\Var}
                {(\text{inc} : Int \arr Int) \in \Gamma_1}
                {\synjudg{\Gamma_1}{x}{A}{\Gamma_1}}
                \\
                \Infer{\ArrApp}
                    {\chkjudg{\Gamma_1}{x}{Int}{\Delta} [4]}
                    {\appjudg{\Gamma_1}{x}{[\Gamma_1] (Int \arr Int)}{Int}{\Delta}}
            }
           {\synjudg{\Gamma_1}{\text{inc x}}{\bhat}{\Delta}}
