...
\label{c2:next_ui}
At this phase of the project, the current version of the web UI is a proof of concept. See \ref{fig:screenshot_cycle_1_end} for the current state. The UI requires a total redesign
