...
\end{lstlisting}
\todo{split description beteen what type of node pattern is}

We must be careful to distinguish betweens situations where we know we cannot match a pattern 
\begin{lstlisting}[language=SFL]
match list {
    | Cons _ (Cons _ _) -> true
    | _ -> false
