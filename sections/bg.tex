...
The lambda calculus (\lcalc) was described by Alonzo Church in 1936 \cite{church1936unsolvable}. Below is a definition of the \lcalc
\cite{barendregt2013lambda}
...
We will now attempt to derive the type of $x$, in order to show that it is untypable.
...
\subsection{Polymorphic fuctions}
